...
<h3><?php echo __NP_BLOGRANK_EDIT_TITLE . $popup['rank'] ?></h3>

<form method="post" action="<?php echo $plugin['url'] ?>index.php"><div>
	<input name="action" value="rankupdate" type="hidden" />
	<input name="context" value="blog" type="hidden" />
	<table>
	<thead>
		<tr><th><?php echo __NP_RANK_ID ?></th><th><?php echo __NP_RANK_BLOGNAME ?></th><th><?php echo __NP_RANK_RANK ?></th><th><?php echo _LISTS_ACTIONS ?></th></tr>
	</thead>
	<tbody>
	...
	<?php foreach ($rank as $r): ?>
		...
		<tr>
			<td><?php echo $r['id'] ?></td>
			<td><img src='images/globe.gif' width='13' height='13' alt='' /> <?php echo $r['name'] ?></td>
			<td>
			...
			<td><a href="<?php echo $plugin['url'] ?>index.php?action=catrankedit&amp;blogid=<?php echo $r['id'] ?>"><?php echo __NP_CATRANK_EDIT_TITLE ?></a></td>
		</tr>
